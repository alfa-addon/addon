...
def mainlist(item):
    ...
    ## OUT  itemlist.append(Item(channel=item.channel, title="RealLifeCam" , action="submenu", url= "https://reallifecam.to/", chanel="reallifecam", thumbnail = "https://reallifecam.to/images/logo/logo.png", cat="yes"))
    ...
    ## OUT  itemlist.append(Item(channel=item.channel, title="VoyeurLifeHouse" , action="submenu", url= "https://www.voyeur-house.life/", chanel="voyeurlife", thumbnail = "https://www.voyeur-house.life/images/logo/logo.png"))
