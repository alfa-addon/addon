...
#  https://txxx.com  https://hclips.com    https://hdzog.com  https://hotmovs.com   https://manysex.com/
#  https://tubepornclassic.com  https://upornia.com    https://vjav.com   https://voyeurhit.com   
#  https://desiporn.tube/  https://gettranny.com  https://mrgay.com/  https://porntop.com/   
#  https://pornzog.com/    https://see.xxx/  https://shemalez.com/  https://thegay.com/  https://tporn.xxx/
...
def mainlist(item):
    ...
    # itemlist.append(Item(channel=item.channel, title="Pornstar" , action="section", url=host + "api/json/models/86400/%s/filt........../most-popular/48/1.json" %"str", extra="PornStars"))
...
def section_matches(item, matches_int, **AHkwargs):
    ...
    if matches_int.get('count'): AlfaChannel.finds['controls']['cnt_tot'] = matches_int.get('count', findS['controls']['cnt_tot'])
    if matches_int.get('total_count'):
        total = matches_int.get('total_count', 0)
        AlfaChannel.last_page = int(total) / AlfaChannel.finds['controls']['cnt_tot']
    
    if matches_int.get('categories', {}): 
        matches_int = matches_int.get('categories', {}).copy()
        c_type = 'categories'
    elif matches_int.get('channels', {}): 
        matches_int = matches_int.get('channels', {}).copy()
        c_type = 'channel'
    elif matches_int.get('models', {}): 
