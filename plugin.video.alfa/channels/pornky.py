...
finds = {'find': {'find_all': [{'tag': ['div'], 'class': ['video']}]},
         ...
         'next_page': {},
         'next_page_rgx': [['\/\d+', '/%s/']], 
         'last_page': dict([('find', [{'tag': ['div'], 'class': ['pages']}]), 
         ...
         'url_replace': [], 
         'profile_labels': {
                            'section_title': {'find': [{'tag': ['img'], '@ARG': ['alt']}]},
                            'section_cantidad': dict([('find', [{'tag': ['span'], 'class': ['info']}]),
