...
finds = {'find':  dict([('find', [{'tag': ['div'], 'class': ['block-thumbs']}]),
         ...
         'next_page_rgx': [['/\d+/', '/%s/'], ['&from_videos=\d+', '&from_videos=%s'], ['&from=\d+', '&from=%s']], 
         ...
         'profile_labels': {
                            ...
                            # 'list_all_premium': dict([('find', [{'tag': ['span'], 'class': ['ico-private']}]),
                                                       # ('get_text', [{'tag': '', 'strip': True}])]),
                            'section_cantidad': dict([('find', [{'tag': ['span', 'div'], 'class': ['videos', 'column', 'rating', 'text']}]),
