...
#  https://hclips.com  https://hotmovs.com  https://hdzog.com  https://upornia.com  https://vjav.com  
#  https://txxx.com  https://voyeurhit.com  
canonical = {
             'channel': 'TXXX', 
             'host': config.get_setting("current_host", 'TXXX', default=''), 
             'host_alt': ["https://txxx.com"], 
             'host_black_list': [], 
