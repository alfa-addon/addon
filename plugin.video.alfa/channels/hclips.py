...
def submenu(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Canal" , action="section", url=host + "api/json/channels/14400/%s/most-viewed/60/..1.json" %item.orientation, orientation=item.orientation, extra="Canal"))
...
def section_matches(item, matches_int, **AHkwargs):
    ...
    for elem in matches_int:
        ...
        try:
            ...
            if  elem.get('cf4', ''):  elem_json['thumbnail'] = elem.get('cf4', '')
