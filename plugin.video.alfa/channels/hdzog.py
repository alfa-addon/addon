...
host = 'https://hdzog.com'    # 'https://txxx.com'
...
def search(item, texto):
    ...
    item.url = "https://hdzog.com/api/videos.php?params=259200/str/relevance/60/search..1.all..&s=%s" % texto
...
def lista(item):
    ...
    for Video in  JSONData["videos"]:
        ...
        scrapedurl = "https://hdzog.com/embed/%s" %video_id
        if scrapedhd:
